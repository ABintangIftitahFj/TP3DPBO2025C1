...
int main()
{
    ...
    // melakukan adding Mouse
    Mouse *mouse1 = new Mouse("Logitech", "G502", "RGB", "Wired", "Laser");
    ...
    std::list<Komputer *> listKomputer;
    listKomputer.push_back(myComputer1);
    listKomputer.push_back(myComputer2);

    // Iterasi dan menampilkan informasi menggunakan iterator
    std::list<Komputer *>::iterator i;
    for (i = listKomputer.begin(); i != listKomputer.end(); i++)
    {
        (*i)->show_info(); // Menampilkan informasi dari setiap objek komputer
    }
